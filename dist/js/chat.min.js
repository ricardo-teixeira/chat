...
(function(){angular.module("ValueChat").directive("chatPopup",["ChatAPI","$rootScope","$timeout","$filter","$window",function(e,t,o,s,a){var i="<div class='popup-box chat-popup slim-scrollbar' ng-class=\"{'popup-on': popup.unreadMessages > 0, 'popup-closed': !popup.toggle}\"><div class='popup-head'><ul class='popup-head-left chat-navbar left'><li><a class='chat-navbar-brand' href='javascript:;' title='{{popup.participant[0].name}}'><span chat-status='popup.participant[0].status'></span> {{popup.participant[0].name | trim:true:14}}<div loading-dots ng-if='popup.typing'></div></a></li></ul><div class='popup-head-right'><ul class='chat-navbar popup-head-buttons right'><li class='chat-popup-toggle' ng-click='togglePopup()'><a href='javascript:;'><i class='fa fa-angle-down'></i></a></li><li class='chat-popup-close'><a href='javascript:;' ng-click='removePopup(popup.roomId)'><i class='fa fa-times'></i></a></li></ul></div></div><div class='tab-content' ng-show=\"isActiveTab('popup-config')\"><ul><li><a href='javascript:;'><i class='fa fa-ban'></i> Bloquear usuário <switch class='pull-right' ng-model='config.block'></switch></a></li></ul></div><div class='popup-messages'><div chat-loader ng-if='!popup.messages.length && !doneMessages || gettingMoreMessages'></div><div class='direct-chat-messages' auto-scroll='popup.messages' auto-scroll-trigger='popup.typing' infinite-scroll='loadMoreMessages()' scroll-inverse='true'><div ng-repeat=\"message in popup.messages | orderBy:'messageDate' track by message.messageDate\" class='direct-chat-msg animate-chat animated' ng-class=\"isMyMessage(message.senderId) ? 'me' : 'user'\"><img alt='message user image' class='direct-chat-img' dummy-image='isMyMessage(message.senderId) ? profile.photo : popup.participant[0].photo' dummy-text='isMyMessage(message.senderId) ? profile.name : popup.participant[0].name'><div class='direct-chat-text' ng-bind-html='message.message | colonToSmiley'></div><div ng-if='isMyMessage(message.senderId)' class='direct-chat-info clearfix'><span class='direct-chat-timestamp'><i class='fa fa-check' ng-show='message.notification[0].readDate'></i><span ng-bind='message.messageDate | amCalendar'></span></span></div></div><div class='direct-chat-msg direct-typing-message user' ng-show='popup.typing'><img alt='message user image' class='direct-chat-img' dummy-image='popup.participant[0].photo' dummy-text='popup.participant[0].name'><div class='direct-chat-text'><div loading-dots></div></div></div></div><div ng-show='errorLog(3)' class='error-log'>{{errorLog(3).message}}</div></div><div class='popup-messages-footer'>"+'<div emoji-form emoji-message="emojiMessage" ng-click="setReadMessages()" ng-keypress="isTyping($event)" ng-disabled="errorLog(3)"><button id="emojibtn"><i class="fa fa-smile-o" aria-hidden="true"></i></button><textarea id="messageInput" ng-model="emojiMessage.messagetext" placeholder="Enviar uma mensagem"></textarea></div></div></div>';return{restrict:"EA",require:"^chatSidebar",template:i,scope:{popup:"=chatPopup",index:"=popupIndex"},replace:!0,tranclude:!0,controller:["$scope","$filter","$sanitize","ChatAPI",function(e,t,o,s){var a={roomId:e.popup.roomId,limit:10,offset:0};e.doneMessages=!1,s.message().get(a).$promise.then(function(t){e.popup.messages=t.data,e.doneMessages=!0},function(t){e.doneMessages=!0,console.log("Error: ",t.statusText)})}],link:function(a,i,n,p){function r(){var e=a.index,t=$(i).width(),o=15*e,s=15,n=t*e+(o+s);0==e&&(n=s),$(i).css({left:n})}a.profile=p.profile,a.errors=[],a.errorLog=function(e){var t=a.errors.filter(function(t){return t.code==e});return t[0]},a.emojiMessage={},a.emojiMessage.replyToUser=function(){a.sendMessage()};var c=!0;a.gettingMoreMessages=!1,a.loadMoreMessages=function(){if(c&&!a.gettingMoreMessages){var t={roomId:a.popup.roomId,limit:a.popup.messages.length+20,offset:a.popup.messages.length};a.doneMessages=!1,a.gettingMoreMessages=!0,e.message().get(t).$promise.then(function(e){return a.gettingMoreMessages=!1,0==e.data.length?(c=!1,!1):(angular.forEach(e.data,function(e){a.popup.messages.push(e)}),void(a.doneMessages=!0))},function(e){a.doneMessages=!0,console.log("Error: ",e.statusText)})}},a.removePopup=function(e){a.popup.popupActive=!1,p.removePopup(e),a.$destroy(),p.popups.length<1&&$("body").removeClass("has-chat-popup-active")},a.sendMessage=function(){try{var e=s("stripHTML")(a.emojiMessage.messagetext),t=a.popup.roomId;e.length&&p.proxy.server.sendMessage(t,e).done(function(){a.$apply(function(){a.emojiMessage.messagetext=""})}).fail(function(e){return console.log("Error: ",e)})}catch(o){a.errors.push({code:"3",message:"Erro ao enviar mensagem. Atualize a página e tente novamente."}),console.log(o)}},a.setReadMessages=function(){if(a.popup.unreadMessages>0){var s;s={roomId:a.popup.roomId,userId:a.profile.id},e.updateallmessages().put(s).$promise.then(function(){p.proxy.server.userReadMessage(s.roomId,s.userId,a.profile.systemType).done(function(){o(function(){a.popup.unreadMessages=0;var e=0;p.contacts.forEach(function(t){return void 0!=t.unreadMessages?e+=t.unreadMessages:void 0}),t.chatNotifications=e},500)}).fail(function(e){console.log("Error: ",e.statusText)})},function(e){})}};var u;u=void 0,a.isTyping=function(e){var o;13!==e.keyCode&&(o=a.popup.roomId,void 0!==u&&clearTimeout(u),u=setTimeout(function(){p.proxy.server.userIsTyping(o,t.user.status_id)},200))},a.$on("$destroy",function(){$(window).width()<768?(i.removeClass("chatSlideInLeft").addClass("chatSlideOutLeft"),o(function(){i.remove()},1e3)):i.remove()}),a.popup.toggle=!0,a.isMyMessage=function(e){return e!=a.popup.participant[0].id},a.$watch("popup.highlight",function(e){e&&(i.addClass("highlight"),setTimeout(function(){i.removeClass("highlight"),a.popup.highlight=!1,a.$apply()},1e3))}),a.togglePopup=function(){a.popup.toggle=!a.popup.toggle},a.$watch("index",function(){r()}),$(window).width()<768?$(i).addClass("chatSlideInLeft"):$(i).addClass("chatSlideInUp"),i.on("click",function(){$(".chat-sidebar, body").addClass("narrow-sidebar")})}}}]).directive("switch",function(){return{restrict:"AE",replace:!0,transclude:!0,require:"?ngModel",template:function(e,t){var o="";return o+="<span",o+=' class="switch'+(t["class"]?" "+t["class"]:"")+'"',o+=t.ngModel?' ng-click="'+t.disabled+" ? "+t.ngModel+" : "+t.ngModel+"=!"+t.ngModel+(t.ngChange?"; "+t.ngChange+'()"':'"'):"",o+=' ng-class="{ checked:'+t.ngModel+", disabled:"+t.disabled+' }"',o+=">",o+="<small></small>",o+='<input type="checkbox"',o+=t.id?' id="'+t.id+'"':"",o+=t.name?' name="'+t.name+'"':"",o+=t.ngModel?' ng-model="'+t.ngModel+'"':"",o+=' style="display:none" />',o+='<span class="switch-text">',o+=t.on?'<span class="on">'+t.on+"</span>":"",o+=t.off?'<span class="off">'+t.off+"</span>":" ",o+="</span>"}}}).directive("dummyImage",function(){return{restrict:"A",scope:{width:"@?",height:"@?",dummyImage:"=?",dummyText:"=",bgcolor:"@?",color:"@?",randomColor:"@?"},link:function(e,t){var o,s,a,i,n,p,r,c;i=function(){var e,t,o;for(o="0123456789ABCDEF".split(""),e="",t=0;6>t;)e+=o[Math.floor(16*Math.random())],t++;return e},o=e.bgcolor||"EEEEEE",s=e.color||"AAAAAA","true"===e.randomColor&&(o=i(),s="FFFFFF"),c=e.width||40,n=e.height||40,r=e.length||2,""!==e.dummyImage&&void 0!==e.dummyImage||(p="img/datagrid_load.gif",t.attr("src",p)),a=function(){if(""!==e.dummyImage&&void 0!==e.dummyImage)return t.attr("src",e.dummyImage);if(null!=e.dummyText){for(var a=e.dummyText.substr(0,r),i="ãàáäâẽèéëêìíïîõòóöôùúüûñç·/_,:;",u="aaaaaeeeeeiiiiooooouuuunc------",l=0,d=i.length;d>l;l++)a=a.replace(new RegExp(i.charAt(l),"g"),u.charAt(l));return p="http://api-valuegaia.gaiacore.com.br/dummy/"+c+"x"+n+"/"+o+"/"+s+"/"+a,t.attr("src",p)}},e.$watchCollection("[dummyImage, dummyText]",function(){return a()})}}}).directive("chatStatus",function(){return{restrict:"EA",scope:{status:"=chatStatus"},link:function(e,t){function o(e){switch(e){case 1:return"online";case 2:return"busy";case 3:return"offline";case 4:return"away"}}e.$watch("status",function(e,s){var a=o(s),i=o(e);$(t).removeClass(a).addClass(i),t.hasClass("chat-status-indicator")||t.addClass("chat-status-indicator")})}}}).directive("autoScroll",function(){return{restrict:"EA",scope:{list:"=autoScroll",typing:"=autoScrollTrigger"},link:function(e,t,o){function s(){var e;e=t.prop("scrollHeight"),$(t).animate({scrollTop:e},100)}o.stopScroll=o.stopScroll||!1,e.$watch("typing",function(e){void 0!=e&&null!=e&&s()}),e.$watchCollection("list",function(){o.stopScroll||s(),o.stopScroll=!1})}}}).directive("chatLoader",function(){return{restrict:"EA",replace:!0,template:'<div class="chat-loader"><svg class="chat-loader-container first" width="35px" height="35px" viewBox="0 0 52 52"><circle class="chat-loader-path" /></svg><svg class="chat-loader-container second" width="35px" height="35px" viewBox="0 0 52 52"><circle class="chat-loader-path" /></svg></div>'}}).directive("chatForm",function(){return{restrict:"A",scope:{action:"&chatFormSubmit"},link:function(e,t){$(t).bind("keydown keypress",function(t){return 13===t.which&&$(this).val().trim().length>0&&!t.shiftKey?(e.$apply(e.action),!1):void 0})}}}).directive("focusOn",["$timeout",function(e){return function(t,o,s){t.$watch(s.focusOn,function(t){t&&e(function(){o[0].focus()})})}}]).directive("loadingDots",function(){return{restrict:"EA",replace:!0,template:'<div class="loading-dots"><span></span><span></span><span></span></div>'}}).directive("infiniteScroll",["$timeout",function(e){return function(t,o,s){var a=o[0];o.bind("scroll",function(){"true"==s.scrollInverse?0==a.scrollTop&&(t.$apply(s.infiniteScroll),e(function(){a.scrollTop=10},100)):a.scrollTop+a.offsetHeight>=a.scrollHeight&&t.$apply(s.infiniteScroll)})}}]).directive("chatPopover",["$compile",function(e){return{restrict:"EA",transclude:!0,template:"<span ng-transclude></span>",scope:{items:"=?popoverItems",title:"@?",content:"=?popoverContent"},link:function(t,o,s){function a(){var a=s.popoverTrigger||"hover",i=s.popoverPlacement||"bottom",n=$('<div class="chat-popover popover"><div class="arrow"></div><div class="popover-content"></div></div>');void 0!=s.title&&""!=s.title&&$(n).find(".popover-content").before('<h3 class="popover-title"></h3>');var p={template:n,content:e(t.content)(t),placement:i,trigger:a,html:!0,title:t.title};t.items&&t.content&&(p.content=e(t.content)(t)),$(o).popover(p)}s.popoverItems?t.$watch("items",function(e){void 0!=e&&a()}):a()}}}]).directive("popupGroup",["$timeout",function(e){var t='<div class="popup-head" ng-class="{\'popup-on\': unreads > 0}"><i class="fa fa-comments"></i><span class="popup-group-count">{{contacts.length}}</span></div><div class="chat-popover popover fade top in" style="width: 300px; left: -100px;">    <div class="arrow"></div>    <div class="popover-content">    <ul class="chat-contact-list ng-scope">    <li ng-repeat="contact in contacts track by $index" class="animate-list ng-scope" ng-class="{\'has-unread\': contact.unreadMessages > 0}" ng-click="openGroupedPopup(contact)">    <div class="left"><span class="contact-photo"><img dummy-image="contact.participant[0].photo" dummy-text="contact.participant[0].name"></span>    <span chat-status="contact.participant[0].status" class="ng-isolate-scope offline chat-status-indicator"></span>    </div>    <div class="right">    <h4 class="contact-name ng-binding" ng-bind-html="contact.participant[0].name | trim:true:28">Rose Mary da Rocha Oliveira</h4>    <div class="contact-last-message ng-binding" ng-bind-html="contact.lastMessage | trim:true:35 | colonToSmiley">dfgfd</div>    </div><i class="fa fa-times chat-popup-close" ng-click="removeFromGroup(contact)"></i></li></ul></div></div>';return{require:"^chatSidebar",restrict:"EA",template:t,replace:!1,transclude:!0,scope:{contacts:"=popupGroup",unreads:"=?popupGroupUnreads"},link:function(t,o,s,a){t.$watch("popupGroupUnreads",function(e){e&&(console.log("n",e),t.unreads=e)}),o.on({click:function(){o.find(".chat-popover").toggle()}}),o.find(".chat-popover").on({click:function(){return!1}}),t.$watch("contacts",function(e,s){function i(e,t){var o=e.getBoundingClientRect(),s=t.getBoundingClientRect();return o.left<=s.left&&o.right>=s.right}void 0!=e&&($(window).on("resize",function(){if($(window).width()<768&&o.find(".chat-popover").hide(),a.popups.length){var e=i($("body")[0],$(".chat-popup").get($(".chat-popup").length-1));if(!e){var s=a.popups[0];a.popups.splice(0,1),a.popupsGrouped.push(s),t.$apply()}}if(a.popupsGrouped.length){var n;if(n=a.popups.length?($(window).width()-$(".chat-sidebar").width())/($(".chat-popup").first().width()*(a.popups.length+1)):($(window).width()-$(".chat-sidebar").width())/275,n=parseInt(n),void 0!=n&&n>0){var s=a.popupsGrouped[0];a.popups.push(s),a.popupsGrouped.splice(0,1),t.$apply()}}}),t.$on("popupremoved",function(){var e=($(window).width()-$(".chat-sidebar").width())/($(".chat-popup").first().width()*(a.popups.length+1));if(void 0!=e&&e>1&&a.popupsGrouped.length){var t=a.popupsGrouped[0];a.popupsGrouped.splice(0,1),a.popups.push(t),a.getGroupUnreads()}}),t.openGroupedPopup=function(e){var o=($(window).width()-$(".chat-sidebar").width())/($(".chat-popup").first().width()*(a.popups.length+1));if(void 0!=o&&1>o){var s=a.popups[0];a.popups.splice(0,1),a.popupsGrouped.push(s),a.getGroupUnreads()}e.popupActive=!0,t.contacts=t.contacts.filter(function(t){return t.roomId!=e.roomId}),a.popups.push(e)},t.removeFromGroup=function(e){e.popupActive=!1,t.contacts=t.contacts.filter(function(t){return t.roomId!=e.roomId}),a.getGroupUnreads()})}),t.$watch("contacts.length",function(s,i){if(s!=i){var n=-(65*t.contacts.length);o.find(".chat-popover").css("top",n-10),o.find(".popover-content").css("height",-1*n),a.popupsGrouped.length&&(e(function(){var e=$(".chat-popup").eq(a.popups.length-1).offset().left+275+20;o.animate({left:e},200)},100),a.getGroupUnreads())}})}}}]).filter("trim",function(){return function(e,t,o,s){if(!e)return"";if(o=parseInt(o,10),!o)return e;if(e.length<=o)return e;if(e=e.substr(0,o),t){var a=e.lastIndexOf(" ");-1!=a&&(e=e.substr(0,a))}return e+(s||"…")}}).filter("highlight",["$sce",function(e){return function(t,o){return o&&(t=t.replace(new RegExp("("+o+")","gi"),'<span class="highlighted">$1</span>')),e.trustAsHtml(t)}}]).filter("html",["$sce",function(e){return function(t){return e.trustAsHtml(t)}}]).filter("stripHTML",function(){return function(e){var t=/(<([^>]+)>)/gi;return e.replace(t,"")}})}).call(this);
